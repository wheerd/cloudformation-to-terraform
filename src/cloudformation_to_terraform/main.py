...
def parse_args(args):
    ...
    """
    parser = argparse.ArgumentParser(description="Cloudformation to Terrafrom converter")
    parser.add_argument("--version", action="version", version="cf2tf {ver}".format(ver=__version__))
    parser.add_argument(
