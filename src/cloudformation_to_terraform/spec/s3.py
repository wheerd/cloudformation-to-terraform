...
class AWS_S3_Bucket_Rule(CloudFormationProperty):
    def write(self, w):
        with w.block("rule"):
            ...
            self.property(w, "Id", "id", StringValueConverter())
            self.property(
                w, "NoncurrentVersionExpirationInDays", "noncurrent_version_expiration_in_days", BasicValueConverter()
            )
...
class AWS_S3_Bucket(CloudFormationResource):
    ...
    def write(self, w):
        with self.resource_block(w):
            self.block(
                w, "AccelerateConfiguration", AWS_S3_Bucket_AccelerateConfiguration
            ...
            self.repeated_block(
                w, "AnalyticsConfigurations", AWS_S3_Bucket_AnalyticsConfiguration
            )  # TODO: Probably not the correct mapping
            ...
            self.repeated_block(
                w, "InventoryConfigurations", AWS_S3_Bucket_InventoryConfiguration
            )  # TODO: Probably not the correct mapping
            self.block(
                w, "LifecycleConfiguration", AWS_S3_Bucket_LifecycleConfiguration
            )  # TODO: Probably not the correct mapping
            self.block(w, "LoggingConfiguration", AWS_S3_Bucket_LoggingConfiguration)
            self.repeated_block(
                w, "MetricsConfigurations", AWS_S3_Bucket_MetricsConfiguration
            )  # TODO: Probably not the correct mapping
            self.block(
                w, "NotificationConfiguration", AWS_S3_Bucket_NotificationConfiguration
            )  # TODO: Probably not the correct mapping
            self.block(w, "ObjectLockConfiguration", AWS_S3_Bucket_ObjectLockConfiguration)
            self.property(
                w, "ObjectLockEnabled", "object_lock_enabled", BasicValueConverter()
            )  # TODO: Probably not the correct mapping
            self.block(
                w, "PublicAccessBlockConfiguration", AWS_S3_Bucket_PublicAccessBlockConfiguration
            )  # TODO: Probably not the correct mapping
